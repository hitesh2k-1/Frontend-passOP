...
const manager = () => {
    ...
    const getPassword = async () => {
        let req = await fetch("https://pass-op-backend.onrender.com")
    ...
    const savePassword = async () => {
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            ...
            await fetch("https://pass-op-backend.onrender.com", {
    ...
    const deletePassword = async (id) => {
        ...
        if (c) {
            ...
            let res = await fetch("https://pass-op-backend.onrender.com", {
